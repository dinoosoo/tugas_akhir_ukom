        ...
        <div class="form-container">
            ...
            <form id="dataForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="subject" name="subject" placeholder="Masukkan Mata Pelajaran" required>
                </div>
                <div class="form-group">
...
<script>
    // JavaScript to handle form submission and add data to the table
    document.getElementById('dataForm').addEventListener('submit', function (event) {
        ...
        newRow.innerHTML = `<td>${name}</td><td>${subject}</td><td>${gender}</td>`;
